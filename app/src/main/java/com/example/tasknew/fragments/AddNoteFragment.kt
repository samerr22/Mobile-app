...
import com.example.tasknew.databinding.FragmentAddTaskBinding
import com.example.tasknew.viewmodel.NoteViewModel


class AddNoteFragment : Fragment(R.layout.fragment_add_task),MenuProvider {
    ...
    private fun saveNote(view: View){
        ...
        if(noteTitle.isNotEmpty()){
            val  note = com.example.tasknew.model.Note(0,noteTitle,noteDesc)//this want to be Note 1.05 video
